export const TRANSLATIONS = {
  English: {
    ...
    recovery_sub: "Write these 3 words down. This is the only way to recover your account.",
  ...
  isiZulu: {
    ...
    recovery_sub: "Bhala lawa magama ayi-3. Lena ukuphela kwendlela yokubuyisela i-akhawunti yakho.",
  ...
  Afrikaans: {
    ...
    recovery_sub: "Skryf hierdie 3 woorde neer. Dit is die enigste manier om jou rekening te herwin.",
